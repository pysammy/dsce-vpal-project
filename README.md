...
- `assignment5/` – Applied probability and statistical inference (empirical distributions, t-test, ANOVA) on the Online Learning & Course Consumption dataset to analyze learner completion, satisfaction, and dropout patterns.
